          ...
          <h5 class="card-title">Create Kantor Pusat</h5>
            ...
            <form action="{{ route('tambahkan') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('NpwpKantorPusat') is-invalid @enderror" name="NpwpKantorPusat" value="{{ old('NpwpKantorPusat') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <textarea class="form-control @error('AlamatKantorPusat') is-invalid @enderror" name="AlamatKantorPusat" rows="2">{{ old('AlamatKantorPusat') }}</textarea>
