...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <div class="card-header py-3">
          <h5 class="card-title">List Penerima</h5>
          <br>
              ...
              <table class="table table-hover table-bordered" style="text-align:center;">
                ...
                @if(count($penerimas)>0)
                            ...
                            <form action="{{ route('deletepen', [$penerima->NoPenerima]) }}" method="POST">@csrf
                                ...
                                <div class="modal-content">
                                    <div class="modal-header" style="display:flex;">
                                        <h5 class="modal-title" id="exampleModalLabel">Hapus Penerima</h5>
                    ...
                    <td colspan="4" style="text-align:center;"><br>
                        <p>Tidak ada penerima yang dapat ditampilkan.</p>
                    </td>
                    @endif
                </tbody>
              </table>
